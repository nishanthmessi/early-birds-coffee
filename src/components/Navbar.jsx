...
const Navbar = () => {
  return (
    <div className='fixed top-0 w-[100vw] flex justify-between items-center h-[100px] pl-[40px] pr-[20px] space-mono font-[400] border-b-[1px] border-[#1D1D1B] text-primary bg-white'>
